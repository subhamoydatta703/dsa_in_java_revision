...
public class bitwise_operators {
    public static void main(String[] args) {
        ...
        // Binary XOR operator -> Symbol -> ^ -> x ^ y -> here ^ this is the XOR operator symbol
        ...
        // Binary left shift -> Symbol -> << -> x << y => (x*(2^y)) -> here ^ this is the power symbol
        System.out.println("Binary left shift: " + (3 << 2));
        // Binary right shift -> Symbol -> >> -> x >> y => (x/(2^y)) -> here ^ this is the power symbol
